...
def get_serial_queryset(hp):
    ...
    list_names = hps.get(hp, [])
    qs = Category.objects.filter(name__in=list_names)
...
def get_serial_search_results(category, q_serial, hp):
    ...
    try:
        brand = get_category_brand(category)
        if hp == '0':  # not selected hp
            qs = get_model_queryset(brand)
        else:
            qs = get_serial_queryset(hp)
        type_of_search_func = META_BRAND_SEARCH_BY_SERIAL[brand.slug][1]
        result = type_of_search_func(qs, q_serial)
        return result
    except KeyError:  # if brand is not recognized, return empty
...
hps = OrderedDict([
    ...
    ('3', ['3 HP']),
    ('3.3', ['3.3 HP']),
    ('3.5', ['3.5 HP', '3.5 (4-Stroke) Carburetor ']),
    ('3.6', ['3.6 HP']),
    ('3.9', ['39 (1 Cylinder)']),
    ('4', ['Model 40 4 HP (1 Cylinder)',
           'Model 40, 4 HP (Gnat 2 Cylinder)',
           '4 HP (1 Cylinder Product of USA)',
           '4 HP (2-Stroke)', '4 HP (4-Stroke)',
           '4 / 5 HP (1 Cylinder Product of Japan)',
           '4 / 5 HP']),
    ('4.5', ['Model 45, 4.5 HP (1 Cylinder)',
             '4.5 HP (1 Cylinder)']),
    ('5', ['5 HP (2-Stroke)',
           '5 HP (4-Stroke)',
           '4 / 5 HP (1 Cylinder Product of Japan)',
    ...
    ('9.9', ['9.9 (2 Cylinder) (International)',
             '9.9 HP',
    ...
    ('10', ['100, 150, 200, 250',
            ...
            '10 HP Viking',
            'XR10', '110']),
    ('13.5', ['13.5 HP (4-Stroke) (International)']),
    ('15', ['100, 150, 200, 250', '15 HP', '15 HP SeaPro',
            '15 HP SeaPro', '15 HP SeaPro (XD)',
            '15 HP Viking', '15 (2 Cylinder) (International)',
            '15 HP (4-Stroke)', '15 Carburetor (2 Cylinder) (4-Stroke)',
            '15 SeaPro (4-Stroke)']),
    ('18', ['18 HP', '18XD HP',
            '18 (2 Cylinder) (International)']),

    ('20', ['200', '100, 150, 200, 250' 'Model 200 20 HP',
            'Model 200, 20 HP', '20 HP (2 Cylinder)',
            '20XD HP (2 Cylinder)', '20 Carburetor (2 Cylinder) (4-Stroke)',
            '20 HP Jet']),
    ('25', ['100, 150, 200, 250',
    ...
    ('65', ['650 (4 Cylinder)', '650 (3 Cylinder)',
            'Model 650 65 HP (3 Cylinder)', '65 HP Jet',
            '65 HP Jet (3 Cylinder)']),
    ('70', ['Model 700 70 HP (6 Cylinder)', '700 (6 Cylinder)',
            '70 HP (3 Cylinder)', '70 (3 Cylinder)']),
    ('75', ['75 HP (3 Cylinder)',
            '75 HP (4 Cylinder)',
    ...
    ('250', ['250 HP (3.0L EFI)',
             ...
             '250 HP / 275 HP']),
    ('275', ['275 HP Verado (4-Stroke) (6 Cylinder)']),
    ('300', ['3.0L EFI SeaPro',
             '300 HP Verado (4-Stroke) (6 Cylinder)']),
    ('350', ['350SCi Verado', 'V-3.4 Liter '])
])
